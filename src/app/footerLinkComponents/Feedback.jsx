  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="text-center mb-10">
        ...
        <p className="text-muted-foreground">We value your input to help improve our services</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <FeedbackCard
          ...
          onClick={() => (window.location.href = "https://www.aicte-india.org/feedback/students.php")}
        />
        ...
        <FeedbackCard
          ...
          onClick={() => (window.location.href = "https://www.aicte-india.org/feedback/faculty.php")}
        />
      </div>
    </div>
  )
  ...
  return (
    <Card className="transition-all hover:shadow-lg">
      ...
      <CardContent className="pt-6">
        ...
        <Button className="w-full bg-primary-color text-primary-foreground hover:bg-primary-color/80" onClick={onClick}>
          {buttonText}
        </Button>
      </CardContent>
    </Card>
