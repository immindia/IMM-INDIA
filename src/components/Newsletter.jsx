                ...
                <div className="relative z-10 max-w-xl mx-auto text-center">
                    ...
                    <div className="mt-6">
                        <form
                            ...
                            />
                            <button
                                className="p-2 px-3 rounded-lg font-medium text-white bg-secondary-color hover:bg-blue-500 active:bg-blue-700 duration-150 outline-none shadow-md focus:shadow-none sm:px-4"
                            >
                                Subscribe
                            </button>
                        </form>
