            ...
            <div className="col-span-12 lg:col-span-6">
              <div className="text-left md:pr-20">
                ...
                <h1 className="text-4xl md:text-6xl leading-tight font-light uppercase tracking-wide">
                  Our  <span className="font-bold">Live Projects International and National</span>
                ...
                <p className="text-xl leading-normal opacity-75 mt-4 mb-6">
                  Gain hands-on experience through our industry-integrated live projects,
                  where students work directly with leading companies to solve real business
                  challenges and implement innovative solutions.
                </p>
                <p className="opacity-50 text-sm ">
                  Our live projects provide invaluable exposure to real-world business scenarios,
                  enabling students to apply classroom learning to practical situations while
                  building strong industry connections and enhancing their professional portfolio.
                </p>
              </div>
            </div>
            <div className="col-span-12 lg:col-span-6">
