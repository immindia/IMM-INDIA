const Newsletter = () => {
  return (
    <section className="py-6 sm:py-14 max-w-screen-xl mx-auto">
      <div className="relative overflow-hidden mx-4 px-4 py-14 rounded-lg sm:rounded-2xl bg-primary-color md:px-8 md:mx-8">
        <div className="relative z-10 max-w-xl mx-auto text-center">
          ...
          <div className="mt-6">
            ...
            >
              ...
              />
              <button className="p-2 px-3 rounded-lg font-medium text-white bg-primary-color hover:bg-blue-500 active:bg-blue-700 duration-150 outline-none shadow-md focus:shadow-none sm:px-4">
                Subscribe
              </button>
            </form>
