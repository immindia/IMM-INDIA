export const clubsData = {
  "All Clubs": [
    ...
    {
      id: "finance-club",
      title: "Finance Club - Bear and Bull",
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
    ...
    {
      id: "global-voices-club",
      title: "Global Voices Club",
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
    ...
    {
      id: "research-club",
      title: "Research Club - Nexus",
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
      description: `The Research Club Nexus is a vibrant, student-driven initiative that champions a culture of research, innovation, and interdisciplinary collaboration within the academic community. This dynamic platform unites students, researchers, and academicians, fostering an environment where knowledge thrives, ideas flourish, and impactful solutions to real-world challenges are developed. Nexus bridges the gap between theory and practice, empowering its members to explore emerging trends, generate innovative ideas, and contribute to transformative research projects.

The club's emphasis on interdisciplinary collaboration brings together individuals from diverse fields, fostering creativity and innovation to solve complex global problems. Nexus actively organizes and hosts academic events, including conferences, seminars, and Faculty Development Programs (FDPs), to facilitate knowledge sharing and skill enhancement. Through these activities, members gain expertise in research methodologies, academic writing, data analysis, and publication strategies. The club also supports its members in publishing their work in reputed journals and presenting at prestigious conferences, contributing to the global academic discourse.
...
Aligned with global objectives like the United Nations Sustainable Development Goals (SDGs), Nexus focuses on impactful research projects addressing innovation, sustainability, climate change, and technological advancements. Regular activities such as hackathons, seminars, and collaborative projects provide hands-on experience and foster a spirit of healthy competition.`,
  ...
  "IT Club": [
    {
      ...
      title: "Technology Workshop 2024",
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
      description: `Annual technology workshop focusing on emerging technologies and their business applications.`,
      date: "March 15, 2024",
      photoCount: 8,
      href: "#",
    },
  ...
  "Maestros Club": [
    {
      id: "marketing-summit-2024",
      title: "Marketing Summit 2024",
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
      description: `Annual marketing conference featuring industry experts and marketing competitions.`,
      date: "April 20, 2024",
      photoCount: 12,
      href: "#",
    },
  ...
  "Finance Club": [
    {
      ...
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
      description: `Interactive workshop on stock market trading and investment strategies.`,
  ...
  "HR Club": [
    {
      id: "hr-conclave-2024",
      title: "HR Conclave 2024",
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
      description: `Annual HR conference discussing latest trends in human resource management.`,
      date: "May 10, 2024",
      photoCount: 10,
      href: "#",
    },
  ...
  "Operations Club": [
    {
      id: "supply-chain-seminar",
      title: "Supply Chain Management Seminar",
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
      description: `Seminar on modern supply chain management practices and challenges.`,
      date: "March 30, 2024",
      photoCount: 7,
      href: "#",
    },
  ...
  "E-Cell Club": [
    {
      ...
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
      description: `54-hour weekend event where aspiring entrepreneurs pitch and develop their business ideas.`,
      date: "April 5-7, 2024",
      photoCount: 15,
      href: "#",
    },
    // Add more E-Cell specific events...
  ],
  "Soft Skills Club": [
    {
      id: "communication-workshop",
      title: "Business Communication Workshop",
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
      description: `Workshop focusing on effective business communication skills.`,
      date: "March 22, 2024",
      photoCount: 5,
      href: "#",
    },
  ...
  "Global Voices Club": [
    {
      id: "international-culture-day",
      title: "International Culture Day",
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
      description: `Celebration of diverse cultures and languages from around the world.`,
      date: "April 15, 2024",
      photoCount: 20,
      href: "#",
    },
    // Add more Global Voices Club specific events...
  ],
  "Research Club": [
    {
      ...
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
      description: `Annual research presentation and discussion forum for students and faculty.`,
      date: "May 20, 2024",
      photoCount: 8,
      href: "#",
    },
    // Add more Research Club specific events...
  ],
  "Sports Club": [
    {
      id: "sports-meet-2024",
      ...
      image: "https://v0.dev/placeholder.svg",
      gallery: [],
      description: `Annual inter-college sports competition featuring various indoor and outdoor sports.`,
      date: "March 25, 2024",
      photoCount: 25,
      href: "#",
    },
    // Add more Sports Club specific events...
  ],
};
