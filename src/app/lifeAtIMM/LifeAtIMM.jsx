...
const LifeAtIMM = () => {
  ...
  useEffect(() => {
    ...
    setDescription(
      "Discover the new infrastructure and vibrant student life at IMM India. Explore modern classrooms, tech-enabled learning, and a dynamic campus environment that fosters holistic development and career growth."
    );
  }, [setTitle, setDescription]);

  const { data } = useFetch("/api/indexBanner.php");
  const [bannerImage, setBannerImage] = useState(
    `${API_ENDPOINTS.BASE}/api/uploads/680fd14484b0a.png`
  ); // Default image
