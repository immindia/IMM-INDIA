...
const MobilePopup = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="md:hidden z-[9999] w-full h-full max-h-[500px] px-5 py-10 aspect-ratio-[5/7]  bg-transparent border-0 rounded-lg overflow-hidden focus:outline-none">
        <a
